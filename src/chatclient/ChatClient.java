...
public class ChatClient {
  ...
  public void launchFrame() throws IOException {
    ...
    usernames.setFont(new Font("Delicious", Font.ITALIC, 18));
    sendButton.setFont(new Font("Delicious", Font.ITALIC, 18));
    quitButton.setFont(new Font("Delicious", Font.ITALIC, 18));
    connectBt.setFont(new Font("Delicious", Font.ITALIC, 18));
